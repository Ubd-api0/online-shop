const styles = {
  ...
  productTitle: "text-[25px] font-[600] font-Roboto text-content",
  productDiscountPrice: "font-bold text-[18px] text-content font-Roboto",
  ...
  input: "w-full border border-border bg-surface text-content p-1 rounded-[5px]",
  activeStatus:

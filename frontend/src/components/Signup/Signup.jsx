...
const Signup = () => {
  ...
  return (
    <div className='min-h-screen bg-surface-alt text-content flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <div>
              ...
              <div className='mt-1'>
                <input
                  ...
                  className='appearance-none block w-full px-3 py-2 border border-border bg-surface text-content rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm'
                />
              </div>
            </div>
            {/* Full Name end */}
            ...
            <div>
              ...
              <div className='mt-2 flex items-center'>
                ...
                <label
                  htmlFor='file-input'
                  className='ml-5 flex items-center justify-center px-4 py-2 border border-border rounded-md shadow-sm text-sm font-medium text-muted bg-surface hover:bg-surface-alt cursor-pointer'
                >

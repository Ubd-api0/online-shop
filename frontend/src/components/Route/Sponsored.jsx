...
const Sponsored = () => {
    return (
        <div
            className={`${styles.section} hidden sm:block bg-surface border border-border py-10 px-5 mb-12 cursor-pointer rounded-xl`}
        >
            <div className="flex flex-wrap gap-6 items-center justify-center lg:justify-between w-full">
